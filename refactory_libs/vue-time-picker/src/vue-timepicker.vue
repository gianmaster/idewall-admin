...
export default {
  ...
  methods: {
    ...
    renderHoursList () {
      this.hours = []
      if(this.hourRange){
        const start = parseInt(this.hourRange[0]), end = parseInt(this.hourRange[1])
    ...
    renderList (listType, interval) {
      ...
      if(this.minuteList){
        this.minutes = this.minuteList
      }else if(this.secondList){
        this.seconds = this.secondList
      }else{
